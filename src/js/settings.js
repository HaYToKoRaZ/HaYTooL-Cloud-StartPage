...
export const Settings = {
  ...
  apply() {
    ...
    document.documentElement.style.setProperty('--folder-cols', this.config.folderColumns || 3);
  },
  ...
  setupListeners() {
    ...
    if (colSelect) {
      colSelect.addEventListener('change', () => {
        document.documentElement.style.setProperty('--folder-cols', colSelect.value);
      });
    }
