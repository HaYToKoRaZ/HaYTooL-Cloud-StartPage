...
/**
 * HaYTooL Cloud StartPage - Hava Durumu Modülü (Open-Meteo API - Ücretsiz)
 */
export const Weather = {
  ...
  async fetchAndRender(forceRefresh) {
    ...
    badge.innerHTML = '<span class="weather-icon">⏳</span><span>' + I18n.t('weather_loading', 'Yükleniyor...') + '</span>';
  ...
  render(data) {
    ...
    badge.innerHTML = '<span class="weather-icon">' + icon + '</span><span>' + data.temp + '°C</span>';
    badge.setAttribute('title', data.city + ' • Nem: %' + data.humidity + ' • Rüzgar: ' + data.wind + ' km/s');
  }
};